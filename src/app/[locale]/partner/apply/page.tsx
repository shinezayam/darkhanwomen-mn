        ...
        <section className="py-20 bg-white">
          <div className="container-max container-spacing">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              {/* Enhanced Form */}
              <Card className="card-modern p-8 shadow-2xl border-2 border-purple-300 bg-gradient-to-br from-white to-purple-50/30 backdrop-blur-sm ring-4 ring-purple-200 scale-105">
