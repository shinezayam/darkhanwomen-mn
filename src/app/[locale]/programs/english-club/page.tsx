...
export default function EnglishClubPage() {
  ...
  const handleRegistration = () => {
    window.location.href = `/${locale}/register?program=english-club`;
  };
      ...
      <main>
        ...
        <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-pink-50 relative overflow-hidden">
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-br from-pink-100/40 to-blue-100/40 rounded-full blur-3xl"></div>
          ...
          <div className="container-max container-spacing relative z-10">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-2xl text-sm font-semibold mb-8 shadow-xl border border-blue-500/20">
                <Globe className="w-5 h-5" />
                <span className="tracking-wide">{locale === 'mn' ? 'Клуб' : 'Club'}</span>
              </div>
              
              <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 mb-6">
                {locale === 'mn' ? 'English Club' : 'English Club'}
              </h1>
              
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                {locale === 'mn'
                  ? 'Англи хэлний клуб. Англи хэл сурах, хөгжүүлэх, харилцаа, мэдлэг.'
                  : 'English language club. Learning English, development, communication, and knowledge.'
                }
              </p>
            </div>
                ...
                <Card className="card-modern shadow-2xl border-0 overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-blue-500 to-blue-600 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-blue-100 text-center text-lg">
                        {locale === 'mn' ? 'English Club-ийн дэлгэрэнгүй мэдээлэл' : 'Detailed information about English Club'}
                      </p>
                    </div>
                  </CardHeader>
                  <CardContent className="p-8 bg-white space-y-6">
                    <p className="body-text text-gray-700">
                      {locale === 'mn'
                        ? 'English Club нь англи хэлний клуб юм. Энэ клуб нь эмэгтэйчүүдэд англи хэл сурах, хөгжүүлэх, харилцаа, мэдлэг олгох зорилготой. Оролцогчид нь англи хэлний ур чадвар, харилцааны ур чадвар, мэдлэг хөгжүүлдэг.'
                        : 'English Club is an English language club. This club aims to provide women with English language learning, development, communication, and knowledge. Participants develop English language skills, communication skills, and knowledge.'
                      }
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-900 mb-2">
                            {locale === 'mn' ? 'Англи хэл' : 'English Language'}
                          </h4>
                          <p className="text-gray-600 text-sm">
                            {locale === 'mn' ? 'Англи хэл сурах, хөгжүүлэх' : 'Learning and developing English'}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-900 mb-2">
                            {locale === 'mn' ? 'Харилцаа' : 'Communication'}
                          </h4>
                          <p className="text-gray-600 text-sm">
                            {locale === 'mn' ? 'Харилцааны ур чадвар' : 'Communication skills'}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-900 mb-2">
                            {locale === 'mn' ? 'Мэдлэг' : 'Knowledge'}
                          </h4>
                          <p className="text-gray-600 text-sm">
                            {locale === 'mn' ? 'Олон улсын мэдлэг' : 'International knowledge'}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            {locale === 'mn' ? 'Нөхөрлөл, сүлжээ' : 'Friendship and network'}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <Card className="card-modern shadow-xl border-0">
                  ...
                  <CardContent className="p-6 pt-4">
                    <p className="text-gray-600 mb-6 leading-relaxed text-center">
                      {locale === 'mn'
                        ? 'English Club-т оролцохыг хүсвэл бүртгүүлээрэй'
                        : 'Register to participate in English Club'
                      }
                    </p>
