...
export default function EqualParticipationPage() {
  const pathname = usePathname();
  const locale = pathname.startsWith('/en') ? 'en' : 'mn';

  const handleRegistration = () => {
    window.location.href = `/${locale}/register?program=equal-participation`;
  };
      ...
      <main>
        ...
        <section className="py-20 bg-gradient-to-br from-green-50 via-white to-pink-50 relative overflow-hidden">
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-br from-pink-100/40 to-green-100/40 rounded-full blur-3xl"></div>
          ...
          <div className="container-max container-spacing relative z-10">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-3 rounded-2xl text-sm font-semibold mb-8 shadow-xl border border-green-500/20">
                <Users className="w-5 h-5" />
                <span className="tracking-wide">{locale === 'mn' ? 'Сургалт, уулзалт' : 'Training & Meetings'}</span>
              </div>
              
              <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 mb-6">
                {locale === 'mn' ? 'Тэгш оролцоо – Тэгш хөгжил' : 'Equal Participation – Equal Development'}
              </h1>
              
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                {locale === 'mn'
                  ? 'Сургалт, уулзалт зохион байгуулж тэгш боломжийг хангах. Хувь хөгжил, тэгш эрх, хөгжүүлэлт.'
                  : 'Organizing training and meetings to ensure equal opportunities. Personal growth, equal rights, and development.'
                }
              </p>
            </div>
                ...
                <Card className="card-modern shadow-2xl border-0 overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-green-500 to-green-600 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-green-100 text-center text-lg">
                        {locale === 'mn' ? 'Тэгш оролцоо – Тэгш хөгжүүлэлтийн дэлгэрэнгүй мэдээлэл' : 'Detailed information about Equal Participation – Equal Development'}
                      </p>
                    </div>
                  </CardHeader>
                  <CardContent className="p-8 bg-white space-y-6">
                    <p className="body-text text-gray-700">
                      {locale === 'mn'
                        ? 'Тэгш оролцоо – Тэгш хөгжил хөтөлбөр нь бүх эмэгтэйчүүдэд тэгш боломж, тэгш эрх олгох зорилготой. Энэ хөтөлбөр нь сургалт, уулзалт, зөвлөгөөн зохион байгуулж, эмэгтэйчүүдийн хувь хөгжил, мэргэжлийн хөгжил, нийгмийн оролцоог хангадаг.'
                        : 'The Equal Participation – Equal Development program aims to provide equal opportunities and equal rights to all women. This program organizes training, meetings, and consultations to ensure women\'s personal growth, professional development, and social participation.'
                      }
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-900 mb-2">
                            {locale === 'mn' ? 'Тэгш боломж' : 'Equal Opportunity'}
                          </h4>
                          <p className="text-gray-600 text-sm">
                            {locale === 'mn' ? 'Бүх эмэгтэйчүүдэд тэгш боломж олгох' : 'Provide equal opportunities to all women'}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            {locale === 'mn' ? 'Хувийн хөгжил, ур чадвар' : 'Personal development and skills'}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-900 mb-2">
                            {locale === 'mn' ? 'Сургалт, уулзалт' : 'Training & Meetings'}
                          </h4>
                          <p className="text-gray-600 text-sm">
                            {locale === 'mn' ? 'Тогтмол сургалт, уулзалт' : 'Regular training and meetings'}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <Card className="card-modern shadow-xl border-0">
                  ...
                  <CardContent className="p-6 pt-4">
                    <p className="text-gray-600 mb-6 leading-relaxed text-center">
                      {locale === 'mn'
                        ? 'Тэгш оролцоо – Тэгш хөгжил хөтөлбөрт оролцохыг хүсвэл бүртгүүлээрэй'
                        : 'Register to participate in Equal Participation – Equal Development program'
                      }
                    </p>
