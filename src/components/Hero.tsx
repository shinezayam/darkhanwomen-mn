...
export default function Hero() {
  ...
  <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 justify-center items-center mb-8 sm:mb-16 px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-5xl mx-auto mb-16">
          {['/images/hero_2_last.jpeg?v=4','/images/hero_1_new.jpg?v=4','/images/hero_3.jpg?v=4','/images/hero_4.jpg?v=4','/images/hero_5.jpg?v=4','/images/hero_6.jpg?v=4'].map((src, idx) => (
